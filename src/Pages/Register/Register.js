            ...
            <div className="row justify-content-around align-items-center pb-5 pt-4 gy-5">
                ...
                <div className="col-lg-5">
                    <div className='theme-color-shadow rounded p-5'>
                        <h3 className='theme-color-turquoise fw-bolder'>Please Register Your Account !!</h3>
                        ...
                        <div className='text-muted my-3 text-center'>
                            Already have an account? Please <Link to='/login' className='text-decoration-none theme-color-turquoise fw-bold register-login-link'>Login</Link>
                        </div>
                    </div>
                </div>
            </div>
