            ...
            <div className="row justify-content-around align-items-center pb-5 pt-4">
                ...
                <div className="col-lg-5">
                    <div className='rounded p-5 theme-color-shadow'>
                        <h3 className='theme-color-turquoise fw-bolder'>Please Sign In !!</h3>
                        ...
                        <div className='text-muted my-3 text-center'>
                            Don't have a account ? Please <Link to='/Register' className='register-login-link text-decoration-none theme-color-turquoise fw-bold'>Register</Link>
                        </div>
                        <button onClick={handleGoogleSignIN} type="submit" className="login-button  py-2 rounded form-control mb-3">Sign In with  <FaGoogle /></button>
                    </div>
                </div>
            </div>
        </div>
